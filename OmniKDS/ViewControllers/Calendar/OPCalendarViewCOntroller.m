...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *btnDone = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"doneIcn"] style:UIBarButtonItemStyleDone target:self action:@selector(doneBtnAction)];
    self.navigationItem.rightBarButtonItem = btnDone;
    
    UIBarButtonItem *btnCancel = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"closeIcn"] style:UIBarButtonItemStyleDone target:self action:@selector(cancelBtnAction)];
    ...
    FSCalendar *calendar = [[FSCalendar alloc] initWithFrame:CGRectMake(0, 44, 400, 450)];
